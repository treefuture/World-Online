...
int main()
{
    ...
    while(b<12) {
        ...
        a2=a2*1.26;//战斗叠加(第二轮顶得值)
        c2=a2-d2;//叠加的值(第二轮顶的值)
        d1=a1-c2;//保存a1的返回值(第一轮顶得值)
        a1=(a1-c2)*1.26;//战斗叠加(第一轮轮顶得值)
    ...
    while(b<16) {
        ...
        a3=a3*1.26;//战斗叠加(第三轮顶的值)
        c3=a3-d3;//顶得值(第三轮顶的值)
        d2=a2-c3;//保留a2的返回值(第二轮顶得值)
        a2=(a2-c3)*1.26;//战斗叠加(第二轮顶得值)
        c2=a2-d2;//叠加的值(第二轮顶的值)
        d1=a1-c2;//保存a1的返回值(第一轮顶得值)
        a1=(a1-c2)*1.26;//战斗叠加(第一轮轮顶得值)
    ...
    while(b<20) {
        ...
        a4=a4*1.26;//战斗叠加的值(第四轮顶的值)
        c4=a4-d4;//顶的值(第四轮顶的值)
        d3=a3-c4;//保留a3的返回值(第三轮顶的值)
        a3=(a3-c4)*1.26;//战斗叠加(第三轮顶的值)
        c3=a3-d3;//顶得值(第三轮顶的值)
        d2=a2-c3;//保留a2的返回值(第二轮顶得值)
        a2=(a2-c3)*1.26;//战斗叠加(第二轮顶得值)
        c2=a2-d2;//叠加的值(第二轮顶的值)
    ...
    while(b<24) {
        ...
        a5=a5*1.26;//战斗叠加的值(第五轮顶的值)
        c5=a5-d5;//顶的值(第五轮顶的值)
        d4=a4-c5;//保留a4的返回值(第四轮顶的值)
        a4=(a4-c5)*1.26;//战斗叠加的值(第四轮顶的值)
        c4=a4-d4;//顶的值(第四轮顶的值)
        d3=a3-c4;//保留a3的返回值(第三轮顶的值)
        a3=(a3-c4)*1.26;//战斗叠加(第三轮顶的值)
        c3=a3-d3;//顶得值(第三轮顶的值)
