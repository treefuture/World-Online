...
public class MoHuaZhanDouDaFuBen {

    public static void MoHuaZhanDouDaFuBenGongJu(int b, int z, double a, double m, double o1, double o2, double o3, double y
    ...
    public static void main(String[] args) {
        ...
        while(b<5) {
            ...
            o5 = o5 - y1 > 0 ? o5 - y1 : 0;
            o6 = o6 - x1 > 0 ? o6 - x1 : 0;
            MoHuaZhanDouDaFuBenGongJu(b, z, a, m, o1, o2, o3, y, o4, o5, o6, x, x1, r, y1, k1, k2, k3, k4, k5, k6);
            if (k1 == 1 && o1 <= 0) {
